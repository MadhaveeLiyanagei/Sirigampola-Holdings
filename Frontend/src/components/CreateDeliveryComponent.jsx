                   ...
                   <div className = "container">
                    ...
                    <tbody>
                      <th>
                        ...
                        <button className="btn_red" onClick={this.SaveDelivery}>Save</button>
                                       
                        </center>
                      </th>
                      <th>
                        <center>
                        <button className="btn_green" onClick={this.cancel.bind(this)} style={{marginLeft: "10px"}}>Cancel</button>
