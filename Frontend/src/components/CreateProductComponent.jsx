...
class CreateProductComponent extends Component {
   ...
   notify(){
       toast.success('Product added to the Product List successfully!', {position: toast.POSITION.TOP_CENTER})
   }

   notify1(){
       toast.error('Product was not added to the Product List!', {position: toast.POSITION.TOP_CENTER})
   }
