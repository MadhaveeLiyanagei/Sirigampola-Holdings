    ...
    SoloAlert.confirm({
      ...
      onOk: async function () {
        try {
          ...
          await this.setState({
            adNotices: this.state.adNotices.filter(
              (adNotices) => adNotices.id !== id
            ),
          });
    ...
    return (
      <div>
        <div className="row">
          ...
          <button className="btn_single_add_component" onClick={this.addNotice}>
            <b>Add Notice</b>
          </button>
        </div>
              ...
              <tbody>
                {this.state.adNotices.map((adNotices) => (
                  <tr key={adNotices.id}>
                    ...
                    <td>
                      <button
                        onClick={() => this.editNotices(adNotices.id)}
                        className="button-up"
                      >
                        <b>Update</b>
                      </button>
                    ...
                    <td>
                      <button
                        onClick={() => this.deleteNotices(adNotices.id)}
                    ...
                    <td>
                      <button
                        onClick={() => this.viewNotices(adNotices.id)}
