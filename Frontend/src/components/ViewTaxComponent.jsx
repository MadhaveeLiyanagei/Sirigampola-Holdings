            ...
            <div>
                ...
                <div className = "card col-md-6 offset-md-3" style={{backgroundColor:"#c0c0c0"}}>
                    ...
                    <div className = "card-body">
                        <div className = "row">
                            <label> <b>ProductID :  </b> { this.state.tax.productID }</label> 

                        </div>
                        <br></br>
                        <div className = "row">
                            <label> <b>Country code : </b> { this.state.tax.countryCode }</label> 

                        </div>
                        <br></br>
                        <div className = "row">
                            <label> <b>Pre-tax price : </b>  { this.state.tax.preTaxPrice } </label>
                
                        </div>
                        <br></br>
                        <div className = "row">
                            <label><b> Tax rate : </b>{ this.state.tax.taxRate } </label>
                             
                        </div>
                        <br></br>
                        <div className = "row">
                            <label> <b>Sub total : </b>{ subTotal=(this.state.tax.preTaxPrice + (this.state.tax.preTaxPrice*this.state.tax.taxRate/100)) } </label>
                             
                        </div>
                        <br></br>
                        <div className = "row">
                            <label><b> VAT : </b>{ this.state.tax.vat } </label>
                            
                        </div>
                        <br></br>
                         
                        <div className = "row">
                            <label> <b> Total price : </b>{  subTotal +  (subTotal*this.state.tax.vat/100)} </label>
